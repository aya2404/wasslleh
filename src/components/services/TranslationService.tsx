...
const translations = {
  ar: {
    ...
    // Main App
    appTitle: 'وصلة',
    appSubtitle: 'منصة شاملة لذوي الاحتياجات الخاصة',
    ...
    // Sign Language
    signLanguageTranslation: 'ترجمة لغة الإشارة',
    signLanguageVideo: 'سيتم عرض فيديو لغة الإشارة هنا',
    signLanguageAI: 'تقنية الذكاء الاصطناعي لتحويل النص إلى لغة الإشارة',
    comingSoon: 'قريباً',
    enableSignLanguage: 'تفعيل لغة الإشارة',
    signLanguageSettings: 'إعدادات لغة الإشارة',
    avatarType: 'نوع الأفتار',
    robotAvatar: 'روبوت',
    humanAvatar: 'إنسان',
    cartoonAvatar: 'كرتوني',
    avatarSize: 'حجم الأفتار',
    avatarPosition: 'موضع الأفتار',
    animationSpeed: 'سرعة الحركة',
    autoShowForHearing: 'إظهار تلقائي لذوي الإعاقة السمعية',
    signLanguageType: 'نوع لغة الإشارة',
    arabicSignLanguage: 'لغة الإشارة العربية',
    internationalSignLanguage: 'لغة الإشارة الدولية',
    americanSignLanguage: 'لغة الإشارة الأمريكية',
    playWelcomeGesture: 'تشغيل إشارة الترحيب',
  ...
  en: {
    ...
    // Main App
    appTitle: 'Waslah',
    appSubtitle: 'Comprehensive Platform for Special Needs',
    ...
    // Contribute & Shop Section
    contributeShop: 'Contribute or Shop',
    ...
    signLanguageVideo: 'Sign language video will be displayed here',
    signLanguageAI: 'AI technology for converting text to sign language',
    ...
    robotAvatar: 'Robot',
    humanAvatar: 'Human',
    cartoonAvatar: 'Cartoon',
    avatarSize: 'Avatar Size',
    avatarPosition: 'Avatar Position',
    animationSpeed: 'Animation Speed',
    autoShowForHearing: 'Auto Show for Hearing Impaired',
    signLanguageType: 'Sign Language Type',
    arabicSignLanguage: 'Arabic Sign Language',
    internationalSignLanguage: 'International Sign Language',
    americanSignLanguage: 'American Sign Language',
    playWelcomeGesture: 'Play Welcome Gesture',
