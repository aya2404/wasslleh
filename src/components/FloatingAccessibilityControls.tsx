  ...
  return (
    <div className={`fixed bottom-6 ${isRTL ? 'left-6' : 'right-6'} z-40 flex flex-col items-center space-y-3`}>
        ...
        <div className="flex flex-col space-y-3 animate-in slide-in-from-bottom-2 duration-300">
          ...
          {onDarkModeToggle && (
            <Button
              ...
              size="lg"
              className="rounded-full w-14 h-14 bg-orange-600 hover:bg-orange-700 shadow-lg transition-all duration-200 hover:scale-105"
          ...
          <Button
            ...
            size="lg"
            className="rounded-full w-14 h-14 bg-green-600 hover:bg-green-700 shadow-lg transition-all duration-200 hover:scale-105"
          ...
          <Button
            ...
            size="lg"
            className="rounded-full w-14 h-14 bg-purple-600 hover:bg-purple-700 shadow-lg transition-all duration-200 hover:scale-105"
      ...
      <Button
        ...
        size="lg"
        className="rounded-full w-14 h-14 bg-blue-600 hover:bg-blue-700 shadow-lg transition-all duration-200 hover:scale-105"
