    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-8">
        <div className="relative">
          <h1 className="text-5xl md:text-6xl font-heading font-bold bg-gradient-to-r from-purple-600 via-orange-500 to-green-600 bg-clip-text text-transparent mb-6">
        ...
        <Card className="max-w-4xl mx-auto border-2 border-purple-200 dark:border-purple-700 shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-center space-x-4">
                  <Button 
                    ...
                    className="bg-gradient-to-r from-purple-600 to-orange-600 hover:from-purple-700 hover:to-orange-700 text-white px-8 py-6 text-lg"
                  >
                ...
                <div className="p-6 bg-gradient-to-r from-purple-50 to-orange-50 dark:from-purple-900/20 dark:to-orange-900/20 rounded-lg">
