...
export function AccessibilitySettingsPanel({
  ...
  return (
    ...
    >
      ...
      >
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 bg-gradient-to-r from-purple-50 to-orange-50 dark:from-purple-900/20 dark:to-orange-900/20">
            ...
            <TabsContent value="accessibility" className="space-y-6 mt-6">
              ...
              <div className="space-y-3">
                ...
                <Select value={disabilityType} onValueChange={setDisabilityType}>
                  <SelectTrigger aria-label={t('selectDisabilityType')} className="border-purple-200 focus:border-purple-400">
