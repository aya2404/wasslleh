  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        <h1 className="font-heading text-4xl font-bold bg-gradient-to-r from-purple-600 to-green-600 bg-clip-text text-transparent">
      ...
      {/* Search Section */}
      <Card className="border-purple-100 dark:border-purple-600/30">
        <CardHeader className="bg-gradient-to-r from-purple-100 to-orange-100 dark:from-purple-600/20 dark:to-orange-600/20">
          <CardTitle className="font-heading flex items-center space-x-reverse space-x-2">
        ...
        <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="font-body pl-10 border-purple-200 focus:border-purple-600"
                />
              </div>
            </div>
          ...
          <Button 
            ...
            className="font-body w-full bg-purple-600 hover:bg-purple-700"
          >
            {loading ? (
              <div className="flex items-center space-x-reverse space-x-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          {routes.length > 0 && (
            <>
              <h2 className="font-heading text-xl font-semibold text-purple-600 dark:text-purple-100">
                ...
                <Card 
                  ...
                  className={`cursor-pointer transition-all hover:shadow-lg border-l-4 ${
                    selectedRoute?.id === route.id 
                      ? 'border-l-purple-600 bg-purple-100 dark:bg-purple-600/20' 
                      : 'border-l-gray-300'
                  }`}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div className="font-body flex items-center space-x-reverse space-x-4 text-sm text-muted-foreground">
                      ...
                      {/* Features */}
                      <div>
                        <h4 className="font-body text-sm font-medium mb-2 text-green-600">
                          {language === 'ar' ? 'المميزات:' : 'Features:'}
                        </h4>
                        <div className="flex flex-wrap gap-2">
                          {route.features.map((feature, index) => (
                            <Badge key={index} variant="outline" className="font-body border-green-200 text-green-600">
                              {feature}
                            </Badge>
                          ))}
                        </div>
                      ...
                      {route.warnings.length > 0 && (
                        <Alert className="border-orange-200 bg-orange-100 dark:bg-orange-600/20">
                      ...
                      <div className="flex items-center space-x-reverse space-x-2 pt-2 border-t">
                        <Button size="sm" className="font-body bg-purple-600 hover:bg-purple-700">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="h-64 bg-gradient-to-br from-purple-100 to-orange-100 dark:from-purple-600/20 dark:to-orange-600/20 rounded-lg flex items-center justify-center">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {nearbyFacilities.map((facility) => (
                <div key={facility.id} className="p-3 border rounded-lg hover:bg-orange-100/50 dark:hover:bg-orange-600/10">
                  <div className="flex items-start justify-between">
                    <div className="space-y-1">
                      <h4 className="font-body text-sm font-medium">{facility.name}</h4>
                      <p className="font-body text-xs text-muted-foreground">{facility.type} • {facility.distance}</p>
                      <div className="flex items-center space-x-reverse space-x-2">
                    ...
                    <div className="text-right space-y-1">
                      <div className="flex items-center space-x-reverse space-x-1">
                        ...
                        <span className="font-body text-xs">{facility.rating}</span>
                      </div>
