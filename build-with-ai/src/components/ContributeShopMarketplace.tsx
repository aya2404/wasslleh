                ...
                {filteredProducts.map((product) => (
                  <Card key={product.id} className="hover:shadow-lg transition-shadow border-[var(--color-pastel-purple)] hover:border-[var(--color-vibrant-orange)]">
                    <div className="relative">
                      <div className="h-48 bg-[var(--color-light-beige)] dark:bg-[var(--color-dark-purple)]/20 rounded-t-lg relative overflow-hidden">
                        <ImageWithFallback
                          src={product.image}
                          alt={product.name}
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex space-x-reverse space-x-2">
                          ...
                          <Button 
                            variant="outline" 
                            size="icon"
                            className="border-[var(--color-dark-purple)] text-[var(--color-dark-purple)] hover:bg-[var(--color-dark-purple)] hover:text-white"
                          >
                            <Heart className="w-4 h-4" />
                          </Button>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="w-full bg-[var(--color-light-beige)] rounded-full h-2">
                            <div 
                              className="bg-gradient-to-r from-[var(--color-dark-purple)] to-[var(--color-vibrant-orange)] h-2 rounded-full transition-all"
