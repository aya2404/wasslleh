...
import { Search, Filter, Briefcase, MapPin, Clock, Heart, ExternalLink, Star, Building, DollarSign } from 'lucide-react';
...
export function JobOpportunitiesExplorer() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search and Filters */}
      <Card className="border-purple-100 dark:border-purple-600">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 border-purple-100 focus:border-purple-600"
              />
            </div>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {filteredJobs.map((job) => (
              <Card key={job.id} className="hover:shadow-lg transition-shadow border-l-4 border-l-purple-100">
                <CardContent className="p-6">
                  <div className="space-y-4">
                    {/* Job Header */}
